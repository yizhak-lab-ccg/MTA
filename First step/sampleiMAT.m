...
%        2. discrete_data - A discrete vector (1,-1,0), describing reactions that are
%		    highly/lowly/moderately expressed at the source state (a column vector)
%
%Output - 1. sample_points - iMAT sample points
%         2. v_ref -  The average over the above sample points
